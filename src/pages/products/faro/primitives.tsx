/* ═══════════════════════════════════════════════════════════════════════
   FARO — shared bespoke primitives for the product page sections.

   Mirror the reference build's small helpers (MonoLabel / GhostNumeral /
   MaskLines / frame chrome) re-expressed on our token system: color comes from
   `var(--accent)` / `var(--text*)` / `var(--line*)`, never hex. No shadows, no
   gradients — see .claude/design.md.
   ═══════════════════════════════════════════════════════════════════════ */
